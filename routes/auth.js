...
const {
        place_recharge, register, login, forgotPassword,
        ...
        get_amounts, delete_controller, admin_login,
...
router.post('/reset_withdrawal_password', reset_withdrawal_password);
router.post('/comissions', commission);
router.post('/userdetailsUpdate', userdetailsUpdate);
router.post('/signinReward', signinReward);
router.post('/task_reward', task_reward);
